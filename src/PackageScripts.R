...
#' The tidyverse presents a small vocabulary of verbs to execute most data-related
#' tasks in a time-efficient manner. By composing data tasks as sentences comprising 
#' these verbs, data analysis turns into poetry. In sum, there is a near-direct 
#' translation from intention to code.
#' 
#' The data set used in this vignette is the flight departure data from New York in
#' 2013.
